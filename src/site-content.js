export const siteContent = {
  ...
  testimonials: {
    ...
    title: "Trusted in the spaces that matter most.",
    intro:
      "Homeowners consistently highlight the Anderson team's craftsmanship, communication, cleanliness, and attention to detail.",
    rating: "4.8",
    total: "58 Google reviews",
    sourceHref:
      "https://www.google.com/search?q=anderson+tile+and+granite#lrd=0x8646db1b170956a1:0xab42c1f778ba7e56,1,,,,",
    reviews: [
      {
  ...
  process: {
    eyebrow: "Process",
    title: "From first call to final polish.",
    steps: [
      "Scope the room, surfaces, materials, timeline, and access needs.",
      "Confirm measurements, edge details, pattern direction, and installation plan.",
      "Prepare the site, install with care, clean the work area, and review the finish.",
    ],
  },
  contact: {
